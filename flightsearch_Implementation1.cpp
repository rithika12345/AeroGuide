...
/*Adjacency list-of twenty cities- 0-srinagar->{delhi,leh}
1-leh->{srinagar,jammu,delhi} 2-jammu->{delhi,leh}
3-	kullu->{delhi}

4-	amirtsar->{delhi}

5-	dharmshala->{delhi} 6-chandigarh->{delhi}
7-	dehradun->{delhi,lucknow}

8-	delhi-
>{srinagar,jammu,amritsar,chandigarh,kullu,dharmshala,dehradun,leh,guwahati,bagdogra,kolkata,patna,ranchi,bhubaneshwar,
varanasi,lucknow,allahabad,agra,khajuraho,raipur,jabalpur} 9-jodhpur->{udaipur,delhi}
10-	jaipur->{delhi,mumbai}

11-	agra->{delhi,varanasi,mumbai,gwalior}
 
12-	lucknow->{varanasi,delhi,dehradun,mumbai} 13-bagdogra->{guwahati,kolkata,delhi}
14-udaipur->{jodhpur,delhi,mumbai} 15-gwalior->{agra,mumbai}
16-allahabad->{delhi,mumbai} 17-patna->{delhi}
18-	bhuj->{mumbai}

19-	ahmedabad->{mumbai,delhi,hyderabad} 20-indore->{mumbai,delhi}
21-	bhopal->{mumbai,delhi}

22-	khajuraho->{varanasi,delhi}

23-	varanasi->{lucknow,khajuraho,agra,delhi,mumbai} 24-jamnagar->{mumbai}
25-vadodara->{delhi} 26-ranchi->{delhi}
27-kolkata->{agartala,aizawl,silchar,bagdogra,dimapur,dibrugarh,hyderabad,delhi,port blair,chennai,mumbai,bengaluru} 28-surat->{delhi}
29-	mumbai-
>{pune,aurangabad,goa,ahmedabad,bhuj,jamnagar,hyderabad,indore,bhopal,nagpur,raipur,udaipur,bengaluru,mangalore,visak hapatnam,allahabad,varanasi,bhubhaneshwar,lucknow,jaipur,agra,delhi,kolkata,gwalior,kochi,thiruvananthapuram,kozhikode,c oimbatore}

30-	pune->{mumbai,goa,hyderabad,bengaluru,delhi} 31-aurangabad->{mumbai,delhi}
32-nagpur->{raipur,hyderabad,mumbai,delhi} 33-raipur->{nagpur,mumbai,delhi}
34-	jabalpur->{delhi}

35-	bhubaneshwar->{visakhapatnam,port blair,chennai,mumbai,delhi}

36-	hyderabad->{vijayawada,visakhapatnam,pune,goa,bengaluru,chennai,nagpur,mumbai,tirupur,ahmedabad} 37-goa->{pune,mumbai,hyderabad,kozhikode,kochi}
38-	ijayawada->{hyderabad}
 
39-	isakhapatnam->{bhubaneshwar,hyderabad,chennai,mumbai,delhi} 40-tirupar->{hyderabad}
...
44-	kozhikode->{coimbatore,kochi,mangalore,thiruvananthapuram,goa,mumbai} 45-coimbatore->{kozhikode,mumbai}
46-	tiruchirapalli->{chennai,bengaluru}

47-	kochi->{agatti,thiruvananthapuram,kozhikode,goa,bengaluru,chennai,mumbai,delhi} 48-agatti->{kochi}
49-	madurai->{chennai}

50-	thiruvananthapuram->{kochi,kozhikode,mumbai} 51-port blair->{chennai,bhubaneshwar,kolkata}
52-guwahati->{bagdogra,libabari,delhi,imphal} 53-libabari->{guwahati}
54-dibrugarh->{dimapur,kolkata} 55-tezpur->{silchar}
56-	silchar->{tezpur,kolkata}

57-	dimapur->{dibrugarh,kolkata} 58-imphal->{aizawl,guwahati}
59-	agartala->{kolkata}
...

{
...

    {
        ...
        while (!queue.empty()) {
            ...
            if (pathString.find(cityname1) != std::string::npos && pathString.find(cityname1) != std::string::npos) {

                printf("\n\n\n\tMessage:\n\n");

                printf("\tThe Shortest Path the User can take to reach the destination:\n\n\t");
                cout << pathString;
                break;
            }
        }
